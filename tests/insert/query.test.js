...
describe("query function", () => {
  ...
  it("should generate a valid SQL INSERT query with name and age props and return Id", () => {
    ...
    expect(query).toBe(
      'INSERT INTO public.persons (name, age, "creatorId", "creatorName") VALUES ($1, $2, $3, $4), ($5, $6, $7, $8) RETURNING id'
    );
    expect(args).toEqual([
      'John', 30, 1, 'consumer',
      'Henry', 40, 1, 'consumer'
  ...
  it("should generate a valid SQL INSERT query with name and age props and return nothing", () => {
    ...
    const { query, args } = entity.query.insert(chunk, consumer, rtn);
    expect(query).toBe(
      'INSERT INTO public.persons (name, age, "creatorId", "creatorName") VALUES ($1, $2, $3, $4), ($5, $6, $7, $8)'
    );
    expect(args).toEqual([
      'John', 30, 1, 'consumer',
      'Henry', 40, 1, 'consumer'
  ...
  it("should generate a valid SQL INSERT query with age prop and return Id", () => {
    ...
    expect(query).toBe(
      'INSERT INTO public.persons (age, "creatorId", "creatorName") VALUES ($1, $2, $3), ($4, $5, $6) RETURNING id'
    );
    expect(args).toEqual([
      30, consumer.userId, consumer.nickname,
      40, consumer.userId, consumer.nickname
    ]);
  });
