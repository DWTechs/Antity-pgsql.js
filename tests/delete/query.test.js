...
describe("query function", () => {
  ...
  describe("delete by ID", () => {
    it("should generate a valid SQL DELETE query with given IDs", () => {
      ...
      expect(result.query).toBe("DELETE FROM public.persons WHERE id = ANY($1)");
  ...
  describe("deleteArchive", () => {
    it("should generate a valid SQL query to call hard_delete function", () => {
      const result = entity.query.deleteArchive();
      expect(result).toBe("SELECT hard_delete($1, $2, $3)");
    });
    ...
    it("should generate the same query regardless of repeated calls", () => {
      ...
      expect(result1).toBe("SELECT hard_delete($1, $2, $3)");
    });
  });
